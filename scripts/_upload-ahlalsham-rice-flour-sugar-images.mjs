#!/usr/bin/env node
/**
 * Upload local product images for Ahl El Sham "منيو الرز و الدقيق و السكر" category ONLY.
 * Idempotent: skips products that already have image_url (use --force to re-upload).
 *
 * Usage:
 *   node scripts/_upload-ahlalsham-rice-flour-sugar-images.mjs [--dry-run] [--force] [--dir path]
 */
...
const CATEGORY_ID = '5242c9df-d1eb-4203-a52f-b4c9a6c87e80';
const CATEGORY_AR = 'منيو الرز و الدقيق و السكر';
const DEFAULT_IMAGE_DIR =
  'C:\\Users\\Administrator\\Downloads\\pilot_الرز_و_الدقيق_و_السكر_1\\الرز و الدقيق و السكر';
const REPORT_PATH = join(ROOT, 'scripts', 'last-ahlalsham-rice-flour-sugar-images-report.json');
