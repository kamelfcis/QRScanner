#!/usr/bin/env node
/**
 * Upload local product images for Ahl El Sham "القهوة و الشاي" category ONLY.
 * Idempotent: skips products that already have image_url (use --force to re-upload).
 *
 * Usage:
 *   node scripts/_upload-ahlalsham-coffee-tea-images.mjs [--dry-run] [--force] [--dir path]
 */
...
const CATEGORY_ID = 'f7701214-50dc-489e-9e1d-24d78e9c1de1';
const CATEGORY_AR = 'القهوة و الشاي';
const DEFAULT_IMAGE_DIR =
  'C:\\Users\\Administrator\\Downloads\\القهوة و الشاي\\القهوة و الشاي';
const REPORT_PATH = join(ROOT, 'scripts', 'last-ahlalsham-coffee-tea-images-report.json');
