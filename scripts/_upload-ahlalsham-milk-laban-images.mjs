#!/usr/bin/env node
/**
 * Upload local product images for Ahl El Sham "منيو الحليب و اللبن" category ONLY.
 * Idempotent: skips products that already have image_url (use --force to re-upload).
 *
 * Usage:
 *   node scripts/_upload-ahlalsham-milk-laban-images.mjs [--dry-run] [--force] [--dir path]
 */
...
const CATEGORY_ID = 'a1aa0d99-12cf-4612-b977-d83f81ad2dd1';
const CATEGORY_AR = 'منيو الحليب و اللبن';
const DEFAULT_IMAGE_DIR =
  'C:\\Users\\Administrator\\Downloads\\منيو_الحليب_واللبن_1\\منيو الحليب و اللبن';
const REPORT_PATH = join(ROOT, 'scripts', 'last-ahlalsham-milk-laban-images-report.json');
