#!/usr/bin/env node
/**
 * Upload local product images for Ahl El Sham "منيو الاعشاب" category ONLY.
 * Idempotent: skips products that already have image_url (use --force to re-upload).
 *
 * Usage:
 *   node scripts/_upload-ahlalsham-herbs-images.mjs [--dry-run] [--force] [--dir path]
 */
...
const CATEGORY_ID = '9de129a5-d201-4895-ae89-39736be6dd7d';
const CATEGORY_AR = 'منيو الاعشاب';
const DEFAULT_IMAGE_DIR =
  'C:\\Users\\Administrator\\Downloads\\منيو_الاعشاب\\منيو الاعشاب';
const REPORT_PATH = join(ROOT, 'scripts', 'last-ahlalsham-herbs-images-report.json');
