#!/usr/bin/env node
/**
 * Upload local product images for Ahl El Sham "كريم شانتيه + الحواج" category ONLY.
 * Idempotent: skips products that already have image_url (use --force to re-upload).
 *
 * Usage:
 *   node scripts/_upload-ahlalsham-chantilly-images.mjs [--dry-run] [--force] [--dir path]
 */
...
const CATEGORY_ID = '6fe6a01d-ca94-43d1-9719-2a18e0a5af52';
const CATEGORY_AR = 'كريم شانتيه + الحواج';
const DEFAULT_IMAGE_DIR =
  'C:\\Users\\Administrator\\Downloads\\كريم شانتيه + الحواج\\كريم شانتيه + الحواج';
const REPORT_PATH = join(ROOT, 'scripts', 'last-ahlalsham-chantilly-images-report.json');
